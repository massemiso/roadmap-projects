...
A user stars a repository (historically referred to as "watching"). The type of activity is specified in the `action` property of the payload object. For more information, see [REST API endpoints for activity](/en/rest/activity#starring).
